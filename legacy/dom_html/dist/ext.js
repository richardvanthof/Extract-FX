...
function onLoaded() {
    ...
    VulcanInterface.addMessageListener(VulcanMessage.TYPE_PREFIX + "com.DVA.message.sendtext", function (message) {
...
function updateThemeWithAppSkinInfo(appSkinInfo) {
    ...
    var isPanelThemeLight = panelBackgroundColor.red > 50;
